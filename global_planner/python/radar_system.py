...
if __name__ == '__main__':
    ...
    layout = go.Layout(
            ...
            title='4 Radar Systems w/ Overlapping Fields of Fire and Obstacles'
        )
    ...
    visualizer_list = []
    for i, radar in enumerate(network_radar_system.radars):
        print(radar.pos.vec)
        data_info = network_radar_system.get_voxels(radar.detection_info, 10,radar.pos.vec)
        data_vis = network_radar_system.get_visual_scatter_radar(data_info,i+1)
